...
<head>
    ...
    <link href="{{url('assets')}}/assets/images/favicon.ico" type="img/x-icon" rel="shortcut icon">
    <!-- All css files are included here. -->
    <link rel="stylesheet" href="{{url('assets')}}/assets/css/vendor/bootstrap.min.css">
    <link rel="stylesheet" href="{{url('assets')}}/assets/css/vendor/iconfont.min.css">
    <link rel="stylesheet" href="{{url('assets')}}/assets/css/vendor/helper.css">
    <link rel="stylesheet" href="{{url('assets')}}/assets/css/plugins/plugins.css">
    <link rel="stylesheet" href="{{url('assets')}}/assets/css/style.css">
    <!-- Modernizr JS -->
    <script src="{{url('assets')}}/assets/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
...
<body>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-2 col-md-4 col-12">
                            <!--Logo Area Start-->
                            <div class="logo-area">
                                <a href="index.html"><img src="{{url('assets')}}/assets/images/logo.png" alt=""></a>
                            </div>
                            <!--Logo Area End-->
                        </div>
                                    ...
                                    <li class="currency-menu"><a href="#"><i class="flaticon-user"></i></a>
                                        ...
                                        <ul class="currency-dropdown">
                                            ...
                                            <li><a href="#">language</a>
                                                <ul>
                                                    <li class="active"><a href="#"><img src="{{url('assets')}}/assets/images/icons/en-gb.png" alt="">English</a></li>
                                                    <li><a href="#"><img src="{{url('assets')}}/assets/images/icons/de-de.png" alt="">French</a></li>
                                                </ul>
                                            </li>
                                        ...
                                        <div class="header-cart">
                                            <ul class="cart-items">
                                                <li class="single-cart-item">
                                                    <div class="cart-img">
                                                        <a href="cart.html"><img src="{{url('assets')}}/assets/images/cart/cart1.jpg" alt=""></a>
                                                    </div>
                                                ...
                                                <li class="single-cart-item">
                                                    <div class="cart-img">
                                                        <a href="cart.html"><img src="{{url('assets')}}/assets/images/cart/cart2.jpg" alt=""></a>
                                                    </div>
                                                    <div class="cart-content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-6 col-md-6">
                                        <div class="header-logo">
                                            <a href="index.html">
                                                <img src="{{url('assets')}}/assets/images/logo.png" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-6 col-md-6">
                        ...
                        <nav class="offcanvas-navigation">
                            <ul>
                                ...
                                <li class="menu-item-has-children"><a href="#">LANGUAGE: EN-GB </a>
                                    <ul class="submenu2">
                                        <li><a href="javascript:void(0)"><img src="{{url('assets')}}/assets/images/icons/en-gb.png" alt=""> English</a></li>
                                        <li><a href="javascript:void(0)"><img src="{{url('assets')}}/assets/images/icons/de-de.png" alt=""> Germany</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav>
                            ...
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="payment-getway text-lg-right text-center">
                                        <img src="{{url('assets')}}/assets/images/payment.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="product-details-left">
                                        <div class="product-details-images">
                                            <div class="lg-image">
                                                <img src="{{url('assets')}}/assets/images/product/large-product/l-product-1.jpg" alt="">
                                            </div>
                                            <div class="lg-image">
                                                <img src="{{url('assets')}}/assets/images/product/large-product/l-product-2.jpg" alt="">
                                            </div>
                                            <div class="lg-image">
                                                <img src="{{url('assets')}}/assets/images/product/large-product/l-product-3.jpg" alt="">
                                            </div>
                                            <div class="lg-image">
                                                <img src="{{url('assets')}}/assets/images/product/large-product/l-product-4.jpg" alt="">
                                            </div>
                                            <div class="lg-image">
                                                <img src="{{url('assets')}}/assets/images/product/large-product/l-product-5.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="product-details-thumbs">
                                            <div class="sm-image"><img src="{{url('assets')}}/assets/images/product/small-product/s-product-1.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="{{url('assets')}}/assets/images/product/small-product/s-product-2.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="{{url('assets')}}/assets/images/product/small-product/s-product-3.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="{{url('assets')}}/assets/images/product/small-product/s-product-4.jpg" alt="product image thumb"></div>
                                            <div class="sm-image"><img src="{{url('assets')}}/assets/images/product/small-product/s-product-5.jpg" alt="product image thumb"></div>
                                        </div>
                                    </div>
                                    <!--Product Details Left -->
                                </div>
    ...
    <script src="{{url('assets')}}/assets/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="https://maps.google.com/maps/api/js?sensor=false&libraries=geometry&v=3.22&key=AIzaSyDAq7MrCR1A2qIShmjbtLHSKjcEIEBEEwM"></script>
    <script src="{{url('assets')}}/assets/js/vendor/popper.min.js"></script>
    <script src="{{url('assets')}}/assets/js/vendor/bootstrap.min.js"></script>
    <script src="{{url('assets')}}/assets/js/plugins/plugins.js"></script>
