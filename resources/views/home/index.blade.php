            ...
            <div class="tab-content">
                <div class="banner-section section pb-40 pb-sm-30 pb-xs-0">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="
                                    ...
                                    mb-30
                                    bg-image"
                                    data-bg="{{ url('assets') }}/assets/images/OxyWater.png" style="object-fit:contain">
                    ...
                    <div id="clothes" class="tab-pane">
                        <div class="row">
                            <div class="col-lg-5 col-md-4 col-sm-6" style="margin-left: 40px">
                                ...
                                <div class="single-grid-product mb-40">
                                    <div class="product-image">
                                        ...
                                        <a href="single-product.html">
                                            <img src="{{ url('assets') }}/assets/images/Clothes-1-miror.jpeg"
                                                class="img-fluid" alt="" style="height: 320px">
                                            <img src="{{ url('assets') }}/assets/images/Clothes-1-miror.jpeg"
                                                class="img-fluid" alt="" style="height: 320px">
                                        </a>
                                    ...
                                    <div class="product-content">
                                        ...
                                        <p class="product-price"><span class="discounted-price">Rp.80.000</span> <span
                                                class="main-price discounted">Rp.100.000</span></p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6" style="margin-left: 20px">
                                ...
                                <div class="single-grid-product mb-40">
                                    <div class="product-image">
                                        <a href="single-product.html">
                                            <img src="{{ url('assets') }}/assets/images/Clothes-2.jpeg"
                                                class="img-fluid" alt="">
                                            <img src="{{ url('assets') }}/assets/images/Clothes-2.jpeg"
                                                class="img-fluid" alt="">
                                        </a>
                                    ...
                                    <div class="product-content">
                                        ...
                                        <p class="product-price"><span class="discounted-price">Rp.50.000</span> <span
                                                class="main-price discounted">Rp.60.000</span></p>
                                    </div>
                                </div>
                                <!--  Single Grid product End -->
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="single-grid-product mb-40">
                                    <div class="product-image">
                                        <a href="single-product.html">
                                            <img src="{{ url('assets') }}/assets/images/Clothes-3.jpeg"
                                                class="img-fluid" alt="">
                                        </a>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="single-grid-product mb-40">
                                    <div class="product-image">
                                        ...
                                        <a href="single-product.html">
                                            <img src="{{ url('assets') }}/assets/images/Clothes-4.jpeg"
                                                class="img-fluid" alt="">
                                            <img src="{{ url('assets') }}/assets/images/Clothes-4.jpeg"
                                                class="img-fluid" alt="">
                                        </a>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="single-grid-product mb-40">
                                    <div class="product-image">
                                        <a href="single-product.html">
                                            <img src="{{ url('assets') }}/assets/images/Clothes-5.jpeg"
                                                class="img-fluid" alt="">
                                            <img src="{{ url('assets') }}/assets/images/Clothes-5.jpeg"
                                                class="img-fluid" alt="">
                                        </a>
                                    ...
                                    <div class="product-content">
                                        ...
                                        <p class="product-price"><span class="discounted-price">Rp.73.500</span> <span
                                                class="main-price discounted">Rp.100.000</span></p>
                                    </div>
                                </div>
                                <!--  Single Grid product End -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-feature mb-30">
                        <div class="feature-image">
                            <img src="{{ url('assets') }}/assets/images/icons/feature-1.png" class="img-fluid"
                                alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-feature mb-30">
                        <div class="feature-image">
                            <img src="{{ url('assets') }}/assets/images/icons/feature-2.png" class="img-fluid"
                                alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-feature mb-30">
                        <div class="feature-image">
                            <img src="{{ url('assets') }}/assets/images/icons/feature-3.png" class="img-fluid"
                                alt="">
                        </div>
                        <div class="feature-content">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="blog col-lg-4 col-md-6">
                    <div class="blog-inner mb-30">
                        <div class="blog-media"><a href="blog-details.html" class="image"><img
                                    src="{{ url('assets') }}/assets/images/blog/blog-1.jpg" alt=""></a></div>
                        <div class="content">
                            <ul class="meta">
                                <li>08 April, 2019</li>
                ...
                <div class="blog col-lg-4 col-md-6">
                    <div class="blog-inner mb-30">
                        <div class="blog-media"><a href="blog-details.html" class="image"><img
                                    src="{{ url('assets') }}/assets/images/blog/blog-2.jpg" alt=""></a></div>
                        <div class="content">
                            <ul class="meta">
                                <li>06 April, 2019</li>
                ...
                <div class="blog col-lg-4 col-md-6">
                    <div class="blog-inner mb-30">
                        <div class="blog-media"><a href="blog-details.html" class="image"><img
                                    src="{{ url('assets') }}/assets/images/blog/blog-3.jpg" alt=""></a></div>
                        <div class="content">
                            <ul class="meta">
                                <li>02 April, 2019</li>
                                    ...
                                    <div class="testimonial-slider-content">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-5">
                                                    <div class="testimonial-image">
                                                        <img src="{{ url('assets') }}/assets/images/testimonial/testimonial-2.png"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                                        ...
                                                        <div class="testimonial-inner">
                                                            <div class="testimonial-author">
                                                                <div class="author-thumb">
                                                                    <img src="{{ url('assets') }}/assets/images/author/author-1.png"
                                                                        alt="">
                                                                </div>
                                        ...
                                        <div class="item">
                                            <div class="row align-items-center">
                                                <div class="col-md-5">
                                                    <div class="testimonial-image">
                                                        <img src="{{ url('assets') }}/assets/images/testimonial/testimonial-1.png"
                                                            alt="">
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
